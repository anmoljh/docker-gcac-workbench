# Galaxy - GCAC dependencies base-image
#
# VERSION 1.0
...
ADD ./gcac-workbench/gcac-dependencies.yaml $GALAXY_ROOT/gcac-dependencies.yaml 
...
RUN install-tools $GALAXY_ROOT/gcac-dependencies.yaml
